...
def new_game():
    global SCORE, level, message, last, ship, lvl_timer, text_flash_timer, once, checked, scores, in_typing, in_hs, laserinterval, laserkey, keyinterval, keypress, blastinterval, bullets, asteroids
    SCORE = 0
    once = True
    checked = False
    scores = False
